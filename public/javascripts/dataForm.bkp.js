...
var g_formMode = window.location.hash || "#single-month-actual";  //Defaults to Monthly Actual Data entry
    /*  
        "year-plan"                 : Adjust form for entering annual plan data year-wise
        "full-month-plan"           : Adjust form for entering monthl plan data for an entire FY
        "single-month-actual"       : Adjust form for entering monthly actual data
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Default Header layout settings
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// UI Changes to be made according to form mode
console.log(g_formMode);
switch (g_formMode) {
    case "#full-month-plan": 
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Adjust Header acording to form mode


//Settings for single month's actual data entry
if(g_formMode == "#single-month-actual"){
...
function adjustHeader(numberOfSchemes){
    ...
    //Firm
    let insertRow = g_rowOffset + 18; //20;
    ...
    //Upside
    insertRow = g_rowOffset + 28 + 4 * (numberOfSchemes-1); // 30 + 4 * (numberOfSchemes-1);
    for (let i = 2; i <= numberOfSchemes; i++) {
...
function adjustHeaderMerge(numberOfSchemes){
    ...
    //For Firm
    let mergeIndex = g_rowOffset + 18; //20;
    ...
    //For Upside
    mergeIndex = g_rowOffset + 28 + (4*(numberOfSchemes-1)); // 30 + (4*(numberOfSchemes-1));
    for (let i = 1; i < numberOfSchemes; i++) {
        g_headerMergeCells.push({ row: mergeIndex, col: 2, rowspan: 4, colspan: 1 });
        mergeIndex+=4;
    }
